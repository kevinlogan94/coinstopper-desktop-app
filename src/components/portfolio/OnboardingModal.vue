<template>
  ...
  >
    ...
    <Card v-else-if="currentStep === 2" class="modal-card">
      <template #title> Add Your Initial Investment </template>
      <template #content>
        <p>
    ...
    <Card v-else-if="currentStep === 3" class="modal-card">
      <template #title> Enable Smart Trading Assistant </template>
      <template #content>
        <p>
          The Smart Trading Assistant will monitor the market, perform trades on
          your behalf, and optimize your portfolio.
        </p>
        <p>Enable it now to let your investments grow automatically!</p>
        <Checkbox
          v-model="enableTracker"
          input-id="enableTracker"
          name="Enable Smart Trading Assistant"
          :binary="true"
        />
    ...
    <Card v-else-if="currentStep === 4" class="modal-card">
      <template #title> You're All Set! </template>
      <template #content>
        ...
        <ul>
          ...
          <li>
            <strong>Smart Trading Assistant:</strong>
            {{ enableTracker ? "Enabled" : "Disabled" }}
          </li>
        </ul>
        <p>
          You can now start tracking your investments and monitoring their
